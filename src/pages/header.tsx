...
import { EuiFlexGroup, EuiFlexItem, EuiIcon, EuiLink, EuiPageHeader } from "@elastic/eui";
...
const Header = () => {
  return (
    <EuiFlexGroup className='header-section'>
      ...
      <EuiFlexItem grow={false}>
      <EuiLink href="https://www.fedsfm.ru/documents/federal-lawss" target="_blank" color="ghost">Ссылка на законодательство</EuiLink>
      </EuiFlexItem>
    </EuiFlexGroup>
  );
};
